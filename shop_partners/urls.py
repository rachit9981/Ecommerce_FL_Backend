...
urlpatterns = [
    ...
    path('deliveries/assigned/', views.delivery_assignment_list, name='delivery_assignment_list'),
    path('deliveries/update_status/<str:order_id>/', views.update_delivery_status, name='update_delivery_status'),
