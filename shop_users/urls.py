...
urlpatterns = [
    ...
    path('login',login, name='login'),    path('add-review/<str:product_id>/', add_review, name='add_review'),
    path('product/<str:product_id>/check_review/', check_user_review, name='check_user_review'),
